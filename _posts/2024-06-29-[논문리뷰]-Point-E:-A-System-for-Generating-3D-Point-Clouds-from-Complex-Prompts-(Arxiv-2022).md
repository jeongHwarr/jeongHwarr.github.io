...
모델은 시간 단계 t에서의 노이즈 상태 $q(x_{t-1}|x_t)$를 신경망 $p_\theta(x_{t-1}|x_t)$로 근사하는 방식으로 학습됩니다. 
Nichol & Dhariwal (2021)은 이때 평균뿐만 아니라 분산도 함께 예측함으로써 더 나은 성능을 얻을 수 있다고 제안했습니다.
